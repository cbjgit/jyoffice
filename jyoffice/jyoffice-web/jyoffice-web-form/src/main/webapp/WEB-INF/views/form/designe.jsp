...
<body>
	<a href="javascript:void(0);" onclick="formDesign.exec('text');" class="btn btn-link">文本框</a>
	<a href="javascript:void(0);" onclick="formDesign.exec('textarea');" class="btn btn-link">多行文本</a>
    <a href="javascript:void(0);" onclick="formDesign.exec('select');" class="btn btn-link">下拉菜单</a>
    <a href="javascript:void(0);" onclick="formDesign.exec('radios');" class="btn btn-link">单选框</a>
    <a href="javascript:void(0);" onclick="formDesign.exec('checkboxs');" class="btn btn-link">复选框</a>
	<script id="formEditor" type="text/plain" style="width:1024px;height:400px;"></script>
...
<script type="text/javascript" charset="utf-8" src="${context}/ueditor/ueditor.config.js"></script>
    ...
    <script type="text/javascript" charset="utf-8" src="${context}/ueditor/formdesign/form.js"></script>
